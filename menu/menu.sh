...
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/zanxcode/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
valid=$(curl -sS https://raw.githubusercontent.com/zanxcode/izin/main/ip | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/zanxcode/izin/main/ip | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
echo -e " ${BIAqua}┌────────────────────────────────────────────────┐${NC}"
echo -e " ${BILime}│ ${BIB}         Zanxcode Project ${NC}${BILime} │${NC}"
echo -e " ${BIAqua}└────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}┌────────────────────────────────────────────────┐${NC}"
...
echo -e " ${BICyan}│${NC} CREATOR      ${NC}:  Zanxcode"
echo -e " ${BICyan}│${NC} TELEGRAM     ${NC}: t.me/dudulrealnofek
echo -e " ${BICyan}└────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}┌────────────────────────────────────────────────┐${NC}"
...
echo -e "        ${BICyan}│$NC Exp Script : $exp ${w}($r $certifacate${NC} ) Days${NC}"
echo -e "        ${BICyan}└─────────────────────────────────────┘${NC}"
echo -e   ""
...
5|05) clear ; menu-set ;;
6|06) clear ; running ;;
7|07) clear ; wget -q https://raw.githubusercontent.com/zanxcode/scvip/update.sh && chmod +x update.sh && ./update.sh ;;
